...
import com.rc.commons.util.CharSetUtil;
...
public class Common {
	 ...
	 * */
	public static String getStrFromReqParam(
	 ...
	 * @return String 转换后的参数值
	 * */
	public static String getISOStrFromReqParam(
		HttpServletRequest request,
		String strParamName) {
		String strISOStr =
			CharSetUtil.getUNCNStr(
				StringUtil.getNotNullStr(request.getParameter(strParamName)));
		return strISOStr;
	}
	/**
	 * 在不同的文件系统中打印根据该文件系统字符集转换而成的字符串日志。
	 * @param strLog String要打印的日志信息
	 * */
	public static void printLog(String strLog) {
		try {
			...
			System.out.println(
				new String(
					strLog.getBytes("GB2312"),
					CharSetUtil.getFileEncoding()));
		} catch (Exception ex) {
			System.out.println("#########################");
			System.out.println(strLog);
		}
	 ...
	 * @param _arrayString 传入的分组字符串:"131,2321"
	...
	public static String getSqlString(String _arrayString) throws Exception {
		...
		try {
			...
			System.out.println(
				"Error at PublicComp.java getSqlString():" + e.getMessage());
			throw e;
		}
	 ...
	 * @param _baseString 原字符串
	 * @param _length 指定长度
	 * @param _firstOrEnd 1:在前面补,2在后面补
	 * @param _char 用于补位的字符
	...
	public static String formatString(
		...
		try {
			...
			System.out.println(
				"Error at PublicComp.java formatString():" + e.getMessage());
			throw e;
		}
	}
	...
	public static long getAvg(long _dividend, long _divisor) throws Exception {
		...
		try {
			...
			System.out.println(
				"Error at PublicComp.java getAvg():" + e.getMessage());
			throw e;
		}
	}
	 ...
	 * @throws java.lang.Exception
	 */
	public static double getPercent(double _dividend, double _divisor)
		throws Exception {
		...
		try {
			...
			//取出小数点后的3位
			String lastString =
				tempAll.substring(tempAll.indexOf(".") + 1, tempAll.length());
			...
			System.out.println(
				"Error at PublicComp.java getPercent():" + e.getMessage());
			throw e;
		}
	}
	/**
	 ...
	 * @param delList List
	 */
	public static void doGetChgList(
		List newList,
		List oldList,
		List addList,
		List delList) {
