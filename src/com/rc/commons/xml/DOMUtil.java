...
public class DOMUtil{
     ...
     * @return Document
     */
    public static Document loadDocumentFromStr(String strFileName){
        Document document = null;
        try{
            InputStream is = new ByteArrayInputStream(strFileName.getBytes());
     ...
     * @return Document
     */
    public static Document loadDocumentFromStr(String strFileName, String charsetName){
        Document document = null;
        try{
            InputStream is = new ByteArrayInputStream(strFileName.getBytes(charsetName));
            document = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new InputSource(is));
        } catch(Exception exception){
        }
        return document;
     ...
     * @param node node of xml document
