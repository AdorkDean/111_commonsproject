...
import com.rc.commons.random.RandomValue;

/**
 * <p>公共方法类</p>
 * <p>该类型提供了在Server端进行动态图形随机
 * 生成的功能</p>
...
public class MakeImageServlet extends HttpServlet {
	...
	/**
	* 动态随机生成图片文件，如果成功返回0,失败返回-1。
	* @param request Servlet的输入
	* @param response Servlet的输出
	* @exception ServletException Servlet的异常抛出
	* @exception IOException      文件IO的异常抛出
	* 无返回值
	**/
